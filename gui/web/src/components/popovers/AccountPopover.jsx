...
const AccountPopover = () => {
  ...
  const decoded = jwt(refreshTokenCookie);
  ...
  return (
    <Box>
      ...
      >
        <Box px={2} pt={1}>
          <H6>{decoded.fullName}</H6>
          <Small color="text.dark">{decoded.email}</Small>
        </Box>

        <Divider />
        <MenuItem>Профил</MenuItem>
        <MenuItem>Аукциони</MenuItem>
        <MenuItem>Настройки</MenuItem>

        <Divider />
        <MenuItem>Излез</MenuItem>
      </Menu>
    </Box>
  );
};
